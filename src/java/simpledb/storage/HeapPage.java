...
//    throw new UnsupportedOperationException("implement this");
    ...
    public void deleteTuple(Tuple t) throws DbException {
        ...
        if (tuples[index] == null) {
            throw new DbException("this tuple is already null");
        } if (!isSlotUsed(index)) {
    ...
    public String byteToBit(byte b) {
        return new StringBuilder(""
                ...
                + (byte) ((b >> 1) & 0x1) + (byte) ((b >> 0) & 0x1)).reverse().toString();
    }

    //    zheli shi yong numEmpty slot haishi  header.length
    public int getNumEmptySlots() {
        // some code goes here
//        String[] stringList = new String[header.length];
//        StringBuilder sr = new StringBuilder();
//        for(int i = 0 ; i < header.length;i++){
//            stringList[i] =   byteToBit(header[i]);
//            sr.append(stringList[i]);
//        }
//        int count =0;
...
//            stringList[j] =   byteToBit(header[j]);
//            sr.append(stringList[j]);
//        }
//        return sr.charAt(i)=='1';
